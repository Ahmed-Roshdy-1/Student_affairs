 ...
 * @author OWNER
 */
public class Student_Information1 extends javax.swing.JFrame {

    /**
     * Creates new form Student_Information
     */
    DefaultTableModel  dtm=new DefaultTableModel();
    public Student_Information1() {
        ...
        try {
            ...
            Logger.getLogger(Student_Information1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Student_Information1().setVisible(true);
            }
        });
    }
